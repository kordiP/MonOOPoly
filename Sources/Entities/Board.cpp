...
void Board::generate()
{
	...
	{
		Property prop(i, "The downtown buildings, prices get steeper.", "Yellow", 50 + i, 250 + i, 125 + i, 175 + i);
		fields.pushBack(prop);
	}
	...
	{
		Property prop(i, "Mid buildings, not too much traffic.", "Teal", 50 + i, 250 + i, 125 + i, 175 + i);
		fields.pushBack(prop);
	}
	...
	{
		Property prop(i, "Affordable buildings, with mild popularity.", "Green", 50 + i, 250 + i, 125 + i, 175 + i);
		fields.pushBack(prop);
	}
	...
	{
		Property prop(i, "The city center, but not the most expensive.", "Grey", 50 + i, 250 + i, 125 + i, 175 + i);
		fields.pushBack(prop);
	}
	...
	{
		Property prop(i, "Luxozenec.", "Grey", 50 + i, 250 + i, 125 + i, 175 + i);
		fields.pushBack(prop);
	}
	...
	{
		Property prop(i, "Office buildings, really expensive.", "Grey", 50 + i, 250 + i, 125 + i, 175 + i);
		fields.pushBack(prop);
	}
	...
	{
		Property prop(i, "The best buildings, get the while you can.", "Grey", 50 + i, 250 + i, 125 + i, 175 + i);
		fields.pushBack(prop);
	}
}
